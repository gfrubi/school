!this code is a lean version of a more complex one so it will
!have some redundant variables that will not be used here but
!for simplicity i will not change those things.
!this code will integrate the wave equation 2 phi,vr + phi,rr =0
!using it in first order form. ie. we define g = phi,r
!and so the equations of motion become
!phi,r = g and g,v = -g,r/2
...
program main
  ...
  !initially we set it to 1 as we 
  !only have the scalar field
  ! will have n
  Nv = 6
